...
const TransformationForm = (
  { action, data = null, userId, creditBalance, type, config = null }: TransformationFormProps
) => {
  ...
  // TODO: Update credit fee to dynamic value
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Button type='submit' className='submit-button capitalize' disabled={isSubmitting}>
            {isSubmitting ? "Sumbitting..." : "Save Image"}
          </Button>
        </div>
